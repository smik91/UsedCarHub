...
namespace UsedCarHub.Domain.Migrations
{
    ...
    [Migration("20240505125004_VinAdd")]
    partial class VinAdd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UsedCarHub.Domain.Entities.AdvertisementEntity", b =>
                {
                    b.HasOne("UsedCarHub.Domain.Entities.CarEntity", "Car")
                        .WithOne("Advertisement")
                        .HasForeignKey("UsedCarHub.Domain.Entities.AdvertisementEntity", "CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
